class FizzBuzzDetector:
    ...
    of replacing every 3rd letter with
    Fizz, and every fifth with Buzz"""
    ...
    def getOverlappings(self):
        ...
        for the incoming string for
        'FizzBuzz' only"""
        return len(self.string) // 15

    def replaceFizzBuzz(self):
        """replaces every third word in
        the letter to Fizz, and every
        fifth letter in the word to Buzz"""
        res = []
